...
import { addAnswer, addQuestions, addReview, deleteCourse, editCourse, getAllCourses, getSingleCourse, getSingleCoursePurchasing, uploadCourse } from "../controller/courseController.js"
...
router.route("/deleteCourse/:id").delete(isAthenticated,authorizeRoles("admin"),deleteCourse)
